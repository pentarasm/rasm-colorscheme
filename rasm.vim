...
hi Comment        guifg=#880000 guibg=bg      gui=none ctermfg=darkgreen  ctermbg=bg     cterm=none
hi Operator       guifg=brown      guibg=bg      gui=none ctermfg=fg         ctermbg=bg     cterm=none
hi Constant       guifg=fg guibg=bg      gui=none ctermfg=darkred    ctermbg=bg     cterm=none
